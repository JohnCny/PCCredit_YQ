...
public class DeGeneralManagerSalaryServiceService extends EmployeeSalaryService {

    DeGeneralManagerSalaryServiceService(String userID){
        setUserID(userID);
    }

    @Override
    double calculateSalary(String YM) {
        return 85/100*((calculateTeamAverageSalary(YM)*2+ getTeamLoanBalance(YM)*15/1000
