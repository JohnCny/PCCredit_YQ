...
public interface LocalImageDao {
	...
	public List<ImageMore> selectAllImageByPcId(ImageMore ImageMore);
	public int selectAllImageByPcIdCount(@Param("pid") String pid,@Param("cid") String cid);
	public List<ImageMore> selectBycardId(ImageMore ImageMore);
	public int selectBycardIdCount(@Param("pid") String pid);
}