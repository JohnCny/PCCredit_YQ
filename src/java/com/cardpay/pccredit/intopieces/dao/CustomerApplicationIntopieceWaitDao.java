...
public interface CustomerApplicationIntopieceWaitDao {
	public List<IntoPiecesFilters> findStatus(@Param(value = "id")String id);
	public List<IntoPiecesFilters> findCustomerApplicationIntopieceDecisionFormes(IntoPiecesFilters filter);
	...
	public int findzsw(@Param(value = "id")String id);
	public IntoPiecesFilters findfsw(@Param(value = "id")String id,@Param(value = "userId")String userId);
	public IntoPiecesFilters findzsw1(@Param(value = "id")String id);
	public IntoPiecesFilters findfsw2(@Param(value = "id")String id,@Param(value = "userId")String userId);
	...
	//审批时查询当前进件所在区域的人
	public List<CustomerApplicationIntopieceWaitForm> findSpRy(String userId);
